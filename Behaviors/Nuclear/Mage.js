...
export class NuclearFrostMageBehavior extends Behavior {
    ...
    return new bt.Selector(
      ...
      new bt.Decorator(
        ...
        new bt.Selector(
          ...
          new bt.Decorator(
            req => this.enemiesAroundTarget(20) >= 7 || this.enemiesAroundTarget(20) >= 3 && me.hasVisibleAura("Ice Caller"),
            this.aoe(),
            new AlwaysSucceed(),
          ),
          ...
          new bt.Decorator(
            req => this.enemiesAroundTarget(20) >= 2 && this.enemiesAroundTarget(20) <= 3 && me.hasVisibleAura("Splinterstorm"),
            this.ss_cleave(),
            new AlwaysSucceed(),
          ),
          ...
          new bt.Decorator(
            req => me.hasVisibleAura("Splinterstorm"),
            this.ss_st(),
            new AlwaysSucceed(),
          ),
  ...
  aoe() {
    return new bt.Selector(
      ...
      spell.cast("Cone of Cold", this.getCurrentTarget, req => this.enemiesForConeOfCold() && me.hasVisibleAura("Coldest Snap") && !me.hasVisibleAura("Comet Storm")),
      ...
      spell.cast("Frostbolt", this.getCurrentTarget, req => me.hasAuraByMe("Icy Veins") && me.getAuraStacks("Death's Chill") < 9 && me.getVisibleAura("Icy Veins")?.remaining > 8000 && me.hasVisibleAura("Death's Chill")),
      ...
      spell.cast("Comet Storm", this.getCurrentTarget, req => (!me.hasVisibleAura("Coldest Snap") || spell.getCooldown("Cone of Cold").ready && spell.getCooldown("Frozen Orb").timeleft > 25000 || (spell.getCooldown("Cone of Cold").timeleft > 10000 && me.hasVisibleAura("Frostfire Bolt") || spell.getCooldown("Cone of Cold").timeleft > 20000 && !me.hasVisibleAura("Frostfire Bolt")))),
      ...
      spell.cast("Flurry", this.getCurrentTarget, req => this.remainingWintersChill() > 0 && (me.hasAuraByMe("Brain Freeze") && !me.hasVisibleAura("Excess Frost") || me.hasAuraByMe("Excess Frost"))),
      ...
      spell.cast("Ice Nova", this.getCurrentTarget, req => this.enemiesAroundMe(20) >= 4 && (!me.hasVisibleAura("Glacial Spike")) && !me.hasVisibleAura("Frostfire Bolt")),
      //actions.aoe += /cone_of_cold,if=!talent.coldest_snap&active_enemies>=7
      spell.cast("Cone of Cold", this.getCurrentTarget, req => !me.hasVisibleAura("Coldest Snap") && this.enemiesInFrontOfMe() >= 7),
  ...
  cleave() {
    return new bt.Selector(
      ...
      spell.cast("Ice Lance", this.getCurrentTarget, req => me.hasVisibleAura("Glacial Spike") && this.remainingWintersChill() === 0 && me.getAuraStacks("Icicles") === 4 && me.hasAuraByMe("Fingers of Frost")),
      ...
      spell.cast("Frozen Orb", this.getCurrentTarget, req => me.hasAuraByMe("Fingers of Frost") && me.getAuraByMe("Fingers of Frost").remaining < 2000 && (!me.hasVisibleAura("Ray of Frost") || spell.getCooldown("Ray of Frost").timeleft > 0)),
      ...
      spell.cast("Cone of Cold", this.getCurrentTarget, req => this.enemiesForConeOfCold() && me.hasVisibleAura("Coldest Snap") && spell.getCooldown("Comet Storm").timeleft > 10000 && spell.getCooldown("Frozen Orb").timeleft > 10000 && this.remainingWintersChill() === 0),
      ...
      spell.cast("Shifting Power", on => me, req => spell.getCooldown("Frozen Orb").timeleft > 10000 && (!me.hasVisibleAura("Comet Storm") || spell.getCooldown("Comet Storm").timeleft > 10000) && (!me.hasVisibleAura("Ray of Frost") || spell.getCooldown("Ray of Frost").timeleft > 10000) || spell.getCooldown("Icy Veins").timeleft < 20000),
  ...
  st() {
    return new bt.Selector(
      ...
      spell.cast("Ice Lance", this.getCurrentTarget, req => me.hasVisibleAura("Glacial Spike") && this.getCurrentTarget()?.hasAuraByMe("Winter's Chill") && me.getAuraStacks("Icicles") === 4 && me.hasAuraByMe("Fingers of Frost")),
      ...
      spell.cast("Frozen Orb", this.getCurrentTarget, req => this.facingForFrozenOrb() && me.getAuraStacks("Fingers of Frost") < 2 && (!me.hasVisibleAura("Ray of Frost") || !spell.getCooldown("Ray of Frost").ready)),
      ...
      spell.cast("Cone of Cold", on => me, req => me.hasVisibleAura("Coldest Snap") && spell.getCooldown("Comet Storm").timeleft > 10000 && spell.getCooldown("Frozen Orb") > 10000 && this.remainingWintersChill() == 0 && this.enemiesInFrontOfMe() >= 3),
      ...
      spell.cast("Blizzard", this.getCurrentTarget, req => this.enemiesAroundTarget(20) >= 2 && me.hasVisibleAura("Ice Caller") && me.hasVisibleAura("Freezing Rain") && (!me.hasVisibleAura("Splintering Cold") && !me.hasVisibleAura("Ray of Frost") || me.hasAuraByMe("Freezing Rain") || this.enemiesAroundTarget(20) >= 3)),
      ...
      spell.cast("Shifting Power", on => me, req =>
        (!me.hasAuraByMe("Icy Veins") && !me.hasVisibleAura("Death's Chill")) &&
        spell.getCooldown("Frozen Orb").timeleft > 10000 &&
        (!me.hasVisibleAura("Comet Storm") || spell.getCooldown("Comet Storm").timeleft > 10000) &&
        (!me.hasVisibleAura("Ray of Frost") || spell.getCooldown("Ray of Frost").timeleft > 10000) ||
  ...
  movement() {
    return new bt.Decorator(
      ...
      new bt.Selector(
        ...
        spell.cast("Cone of Cold", req => !me.hasVisibleAura("Coldest Snap") && this.enemiesInFrontOfMe() >= 2),
